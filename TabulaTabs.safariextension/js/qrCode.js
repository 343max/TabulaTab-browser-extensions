function drawQrCode(valueToEncode, ecclevel, canvas) {
	...
	var genframe = function(instring)
	{
		var x, y, k, t, v, i, j, m;
	...
	qf = genframe(valueToEncode);
	qrc.lineWidth=1;
	var px = Math.floor(Math.min(canvas.width, canvas.height) / width);

	var i,j;
	//qrc.clearRect(0,0,windowWidth,windowHeight);
	qrc.fillStyle = '#fff';
